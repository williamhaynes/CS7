    ...
    <header>
        <nav id="navBar">
            <ul id="header">
                ...
                <li id="healthAndWellbeing"><a href="/inc/healthAndWellbeingPage">Health & Wellbeing</a></li>
                <li id="clubsAndSocieties"><a href="/inc/clubsAndSocietiesPage">Clubs & Societies</a></li>
                <li id="mapPage"><a href="/inc/mapPage">Maps</a></li>
