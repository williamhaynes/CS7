...
<script>
    ...
    function initMap() {
        ...
        var currentPosInfoWindow = new google.maps.InfoWindow({map: map});
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                currentPosInfoWindow.setContent('Location found.');
                map.setCenter(pos);
            }, function() {
                handleLocationError(true, currentPosInfoWindow, map.getCenter());
            });
        } else {
    ...
    function handleLocationError(browserHasGeolocation, currentPosInfoWindow, pos) {
        currentPosInfoWindow.setPosition(pos);
        currentPosInfoWindow.setContent(browserHasGeolocation ?
