        ...
        while($row = $result->fetch_array())
        {
            ...
            <atricle>
                 ...
                 <script>
                    ...
                    if (facebook==1){
                        document.getElementById('facebookUrl').innerHTML = "<a href= facebookUrl ><img border='0' alt=facebookPage src='facebookbrand.com/wp-content/themes/fb-branding/prj-fb-branding/assets/images/fb-art.png' width='100' height='100'>";
                    }
                 </script>
             </atricle>";
        }
